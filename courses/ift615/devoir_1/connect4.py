...
def buildArgsParser():
    ...
    # Paramètres globaux
    p.add_argument('-joueur1', dest="player1", metavar="JOUEUR", action='store', type=str, required=False, default="solution_connect4.py",
                   help="[humain, aleatoire, solution_connect4.py]. Défaut=solution_connect4.py")

    p.add_argument('-joueur2', dest="player2", metavar="JOUEUR", action='store', type=str, required=False, default="solution_connect4.py",
                   help="[humain, aleatoire, solution_connect4.py]. Défaut=solution_connect4.py")
